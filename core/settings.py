...
# HOSTs List
ALLOWED_HOSTS = ['localhost', '127.0.0.1','myenvironment.eba-j5qxychn.ap-south-1.elasticbeanstalk.com','13.233.152.142']
...
if DB_ENGINE and DB_NAME and DB_USERNAME:
    DATABASES = { 
      'default': {
        ...
        'USER'    : DB_USERNAME,
        'PASSWORD': DB_PASS,
        'HOST'    : 'myenvironment.eba-j5qxychn.ap-south-1.elasticbeanstalk.com',
        'PORT'    : 8000,
        }, 
    }
else:
...
AWS_ACCESS_KEY_ID = 'AKIARDLKIIDKL2Z34RNV'
AWS_SECRET_ACCESS_KEY = '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'
AWS_STORAGE_BUCKET_NAME = 'uploadedimagesbyuser'
